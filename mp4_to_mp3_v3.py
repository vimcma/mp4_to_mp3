...
def extract_audio_with_pydub(mp4_file, output_folder, bitrate):
    ...
    try:
        ...
        print(colored("Finished processing: ", "cyan"), f"{mp4_file} -> {mp3_file}")
        ...
        print(colored(f"MP3 file size is {mp3_file_size_mb} MB", "green"))  # Display size of mp3 in MB
        return mp3_file 
...
def main():
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith('.mp4'):
            ...
            print(colored(f"MP4 file size is: {mp4_file_size_mb} MB", "yellow"))  # Display size of mp4 in MB
